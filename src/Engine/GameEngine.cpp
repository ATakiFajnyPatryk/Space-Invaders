...
GameEngine::GameEngine() {
  m_Resolution.x = (float)VideoMode::getDesktopMode().width;
  m_Resolution.y = (float)VideoMode::getDesktopMode().height;

  m_Window.create(VideoMode(m_Resolution.x, m_Resolution.y), "Space Invaders++",
                  Style::Fullscreen);
